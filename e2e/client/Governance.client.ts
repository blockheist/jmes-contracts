...
export interface GovernanceInterface extends GovernanceReadOnlyInterface {
  contractAddress: string;
  sender: string;
  propose: (proposalMsg: ProposalMsg, fee?: number | StdFee | "auto", memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
  vote: ({
    id,
    vote
  }: {
...
export class GovernanceClient extends GovernanceQueryClient implements GovernanceInterface {
  ...
  propose = async (proposalMsg: ProposalMsg, fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
